...
# Inicializa a classe com referencias ao banco de dados e à interface do usuário
...
def excluir_usuario(self):
    if self.ui.selected_user:
        if messagebox.askyesno("Confirmar", "Tem certeza que deseja exluir este usuário?"):
        ...
        messagebox.showerror("Error", "Por favor, selecione um usuário para excluir.")
